  ...
  return {
    ...
    discovery: {
      ...
      qualitySignals: [
        ...
        "Cookbooks are published for copy-paste agent workflows",
        "Built with Action402 ecosystem page is published for examples and submissions",
        "Structured endpoint submission path is published",
        "Postman collection and Action402 agent skill are published for developer onboarding",
